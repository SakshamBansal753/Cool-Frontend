...
const Menu = () => {
    ...
    const goToSlide=(index)=>{
        const newInedx=(index+totalcocktails)%totalcocktails
    ...
    aria-labelledby='menu-heading'>
            ...
            <nav className='cocktail-tabs' aria-label='Cocktail Navigation'>
                {allCocktails.map((cocktail,index)=>{
                    ...
                    return (
                        <button key={cocktail.id} className={`${isActive?'text-white border-white':'text-white/50'}`}
                        onClick={()=>{
                            goToSlide(index)
                        }}>
                            {cocktail.name}
            ...
            <div className='content'>
                <div className='arrows'>
                    <button className='text-left'onClick={()=>goToSlide(currentIndex-1)}>
                        ...
                        <button className='text-rightt'onClick={()=>goToSlide(currentIndex+1)}>
