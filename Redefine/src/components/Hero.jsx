  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
     ...
     <div>
        ...
        className=" bg-[rgba(255,255,255,0.2)] absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] z-50 size-64 cursor-pointer overflow-hidden rounded-lg mask-clip-path flex items-center justify-center ">
       <div
